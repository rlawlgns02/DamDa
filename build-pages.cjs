...
async function buildPages(){
 ...
 await fs.writeFile(path.join(out,'index.html'),index.replace('<html lang="ko">','<html lang="ko" data-hosting="cloud">').replace('<head>','<head>\n<meta name="referrer" content="no-referrer"><meta http-equiv="Content-Security-Policy" content="'+csp+'">').replace('</body>','<script src="runtime-config.js" defer></script><script src="supabase-browser.js" defer></script><script src="qr-browser.js" defer></script><script src="cloud-auth.js" defer></script></body>'));
